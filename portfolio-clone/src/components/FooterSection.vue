...
<template>
  <footer class="border-t border-border/60 mt-12 py-8" role="contentinfo">
    <div class="container mx-auto max-w-3xl px-5 sm:px-6 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
      <!-- Copyright & Info -->
      <div class="font-mono text-xs sm:text-sm text-secondary">
        <p>© 2026 {{ t('name') }}</p>
        <p class="mt-1 text-[11px] sm:text-xs text-secondary/80">
          Built with engineering discipline, precision & Vue 3
        </p>
      </div>
